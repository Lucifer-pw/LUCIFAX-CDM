        ...
        try {
            if (intent.action == "android.intent.action.SIM_STATE_CHANGED") {
                ...
                val state = try {
                    ...
                    Log.e("SIMChangeReceiver", "Exception reading SIM state: ${e.message}")
                    return
                }
                ...
                if (state == TelephonyManager.SIM_STATE_READY) {
                    ...
                    if (lastOperator != null && lastOperator != operatorCode && operatorCode.isNotEmpty()) {
            ...
            Log.e("SIMChangeReceiver", "Error in SIMChangeReceiver onReceive: ${e.message}")
        }
    }
}
